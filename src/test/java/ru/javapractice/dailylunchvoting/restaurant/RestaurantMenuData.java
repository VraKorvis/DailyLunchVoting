...
public class RestaurantMenuData {
    ...
    public static final List<MenuItemAssignment> MENUITEMS_1 = List.of(
            new MenuItemAssignment(MENU_1, BURGER, BigDecimal.valueOf(450)),
            new MenuItemAssignment(MENU_1, PIZZA, BigDecimal.valueOf(800)),
            new MenuItemAssignment(MENU_1, SALAD, BigDecimal.valueOf(250)),
            new MenuItemAssignment(MENU_1, DESSERT, BigDecimal.valueOf(350))
    );

    public static final List<MenuItemAssignment> MENUITEMS_2 = List.of(
            new MenuItemAssignment(MENU_2, SOUP, BigDecimal.valueOf(200)),
            new MenuItemAssignment(MENU_2, EGGS, BigDecimal.valueOf(150))
    );

    public static final List<MenuItemAssignment> MENUITEMS_3 = List.of(
            new MenuItemAssignment(MENU_3, DESSERT, BigDecimal.valueOf(350)),
            new MenuItemAssignment(MENU_3, EGGS, BigDecimal.valueOf(150)),
            new MenuItemAssignment(MENU_3, STEAK, BigDecimal.valueOf(900)),
            new MenuItemAssignment(MENU_3, SUSHI, BigDecimal.valueOf(750)),
            new MenuItemAssignment(MENU_3, COFFEE, BigDecimal.valueOf(100))
    );

    public static final List<MenuItemAssignment> NEW_MENUITEMS = List.of(
            new MenuItemAssignment(NEW_MENU, BURGER, BigDecimal.valueOf(450)),
            new MenuItemAssignment(NEW_MENU, COFFEE, BigDecimal.valueOf(100)),
            new MenuItemAssignment(NEW_MENU, SALAD, BigDecimal.valueOf(250)),
            new MenuItemAssignment(NEW_MENU, DESSERT, BigDecimal.valueOf(350))
    );

    public static final List<MenuItemAssignment> WRONG_NEW_MENUITEMS = List.of(
            new MenuItemAssignment(WRONG_MENU, SALMON, BigDecimal.valueOf(900)),
            new MenuItemAssignment(WRONG_MENU, GRILLED_CHEESE, BigDecimal.valueOf(800)),
            new MenuItemAssignment(WRONG_MENU, COFFEE, BigDecimal.valueOf(100))
    );

    public static final List<MenuItemAssignment> UPDATED_MENUITEMS_1 = List.of(
            new MenuItemAssignment(UPDATED_MENU, BURGER, BigDecimal.valueOf(500)),
            new MenuItemAssignment(UPDATED_MENU, COFFEE, BigDecimal.valueOf(150)),
            new MenuItemAssignment(UPDATED_MENU, SALAD, BigDecimal.valueOf(300)),
            new MenuItemAssignment(UPDATED_MENU, DESSERT, BigDecimal.valueOf(400))
    );

    static {
        MENU_1.setMenuItemAssignments(MENUITEMS_1);
        MENU_2.setMenuItemAssignments(MENUITEMS_2);
        MENU_3.setMenuItemAssignments(MENUITEMS_3);
        NEW_MENU.setMenuItemAssignments(NEW_MENUITEMS);
        WRONG_MENU.setMenuItemAssignments(WRONG_NEW_MENUITEMS);
        UPDATED_MENU.setMenuItemAssignments(UPDATED_MENUITEMS_1);
