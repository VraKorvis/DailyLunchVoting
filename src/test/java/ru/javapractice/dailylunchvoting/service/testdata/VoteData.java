...
public class VoteData {
    ...
    public static final Vote USER1_TODAY_VOTE = new Vote(USER1_VOTE1_ID, LocalDateTime.of(LocalDate.now(), LocalTime.of(9, 45)), RestaurantData.RESTAURANT_C);
    public static final Vote USER1_VOTE2 = new Vote(USER1_VOTE1_ID + 1, LocalDateTime.of(2025, 3, 20, 7, 0, 0), RestaurantData.RESTAURANT_A);
    ...
    public static final Vote USER2_VOTE2 = new Vote(USER1_VOTE1_ID + 3, LocalDateTime.of(2025, 3, 20, 9, 0, 0), RestaurantData.RESTAURANT_C);
    public static final Vote USER1_VOTE3 = new Vote(USER1_VOTE1_ID + 4, LocalDateTime.of(2025, 3, 21, 8, 0, 0), RestaurantData.RESTAURANT_B);
    public static final Vote ADMIN_VOTE_1 = new Vote(USER1_VOTE1_ID + 5, LocalDateTime.of(2025, 3, 21, 9, 0, 0), RestaurantData.RESTAURANT_A);

    private VoteData() {
    }

    public static List<Vote> getAllTestVotesSortedByDate() {
        return Stream.of(USER1_TODAY_VOTE, USER1_VOTE2, USER2_VOTE1, USER2_VOTE2, USER1_VOTE3, ADMIN_VOTE_1)
